...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var techSwiper;
  var priceSwiper;
  var BrandToggleBtn = document.querySelector('.brands__toggle-btn');
  var BrandTogglText = BrandToggleBtn.querySelector('.brands__toggle__link');
  var BrandTogglIcon = BrandToggleBtn.querySelector('.brands__toggle__icon');
  var slides = document.querySelectorAll('.brands__list .swiper-slide');
  var TechToggleBtn = document.querySelector('.technology__toggle-btn');
  var TechTogglText = TechToggleBtn.querySelector('.technology__toggle__link');
  var TechTogglIcon = TechToggleBtn.querySelector('.technology__toggle__icon');
  var Tslides = document.querySelectorAll('.technology__list .swiper-slide');
  var Pslides = document.querySelectorAll('.technology__list .swiper-slide');
  var mobile = window.matchMedia('(min-width: 0px) and (max-width: 767px)');
  var tablet = window.matchMedia('(min-width: 768px) and (max-width: 1439px)');
  ...
  var menuLang = document.querySelector('.menu__lang-switcher');
  var menuOverlay = document.querySelector('.menu-overlay');
  var menuCallBtn = document.querySelector('.menu__call-btn');
  var menuChatCloseBtn = document.querySelector('.chat-form__close-btn');
  var menuChatBtn = document.querySelector('.menu__chat-btn');
  var menuCallCloseBtn = document.querySelector('.call-form__close-btn');
  var menuCallForm = document.querySelector('.call-form');
  var menuChatForm = document.querySelector('.chat-form');
  var headerCallBtn = document.querySelector('.header__call-btn');
  var headerChatBtn = document.querySelector('.header__chat-btn');
  var readMoreBtn = document.querySelector('.read-more__btn');
  var readMoreLink = document.querySelector('.read-more__link');
  var readMoreIcon = document.querySelector('.read-more__icon');
  var promoHighlight = document.querySelector('.promo__highlight--wide');
  var promoParagraph = document.querySelector('.promo__paragraph--expanded');
  var promoFully = document.querySelector('.promo__content--expanded');
  ...
  function BrandInitSwiper() {
    if (window.innerWidth < 768 && !brandSwiper) {
      brandSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.brands__list', {
        loop: true,
        slidesPerView: 'auto',
        spaceBetween: 16,
        pagination: {
  ...
  function TechInitSwiper() {
    if (window.innerWidth < 768 && !techSwiper) {
      techSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.technology__list', {
        loop: true,
        slidesPerView: 'auto',
        spaceBetween: 16,
        pagination: {
  ...
  function PriceInitSwiper() {
    if (window.innerWidth < 768 && !priceSwiper) {
      priceSwiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.prices__list', {
        loop: true,
        slidesPerView: 'auto',
        spaceBetween: 16,
        pagination: {
  ...
  BrandToggleBtn.addEventListener('click', function () {
    var hidden = document.querySelectorAll('.brands__list .swiper-slide.hidden');
  ...
  function TechIinitGrid() {
    if (window.innerWidth >= 768) {
      var visibleCount = TechnologyGetVisibleCount();
      Tslides.forEach(function (slide, index) {
        slide.classList.toggle('hidden', index >= visibleCount);
      });
  ...
  TechToggleBtn.addEventListener('click', function () {
    var hidden = document.querySelectorAll('.technology__list .swiper-slide.hidden');
  ...
  function handleDeviceChange() {
    if (mobile.matches || tablet.matches) {
      ...
      menuOverlay.addEventListener('click', function () {
        if (menuCallForm.classList.contains('active') || menuChatForm.classList.contains('active')) {
      ...
      menuCallBtn.addEventListener('click', function () {
        menuCallForm.classList.add('active');
        menuOverlay.style.zIndex = '40';
      });
      menuCallCloseBtn.addEventListener('click', function () {
      ...
      menuChatCloseBtn.addEventListener('click', function () {
  ...
  BrandInitGrid();
  TechIinitGrid();
  handleDeviceChange(); // пересоздаём при изменении размера
